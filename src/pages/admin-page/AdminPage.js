  ...
  return (
    <div className="admin-container">
      <header className="admin-header">
        <LinkR to="/" className="admin-back-button">
          &lt; Back
        </LinkR>
        ...
        <div className="admin-right-panel">
          ...
          <div className="admin-io-container">
            <div className="admin-upload-form">
              ...
              />
              <label className="admin-upload-label" htmlFor="file">
                Choose File
              </label>
              <button className="admin-upload-button" onClick={ShowUploadModal}>
                Upload
              </button>
            </div>
          </div>
